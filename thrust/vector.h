...
/*! \file vector.h
 *  \brief A dynamically-sizable array of elements which reside in the UVM memory space
 */
...
/*! A \p vector is a container that supports random access to elements,
 *  constant time removal of elements at the end, and linear time insertion
 *  and removal of elements at the beginning or in the middle. The number of
 *  elements in a \p vector may vary dynamically; memory management is
 *  automatic. The memory associated with a \p vector resides in the UVM address
 *  space, and can be access from both host and device.
 *
    ...
    : public detail::vector_base<T,Alloc>
{
  ...
  public:
    ...
    /*! This constructor creates a \p vector with the given
     *  size.
    ...
    template<typename OtherT, typename OtherAlloc>
    __host__
    vector &operator=(const host_vector<OtherT,OtherAlloc> &v)
    { Parent::operator=(v); return *this; }
    
    /*! Assign operator copies from an examplar \p device_vector.
     *  \param v The \p device_vector to copy.
     */
    template<typename OtherT, typename OtherAlloc>
    __host__
    vector &operator=(const device_vector<OtherT,OtherAlloc> &v)
    { Parent::operator=(v); return *this; }

    /*! This constructor builds a \p vector from a range.
